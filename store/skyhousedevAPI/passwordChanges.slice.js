...
export const rest_auth_password_change_create = createAsyncThunk("passwordChanges/rest_auth_password_change_create", async payload => {
...
const passwordChangesSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(rest_auth_password_change_create.pending, (state, action) => {
