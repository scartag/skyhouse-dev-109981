...
export const rest_auth_user_retrieve = createAsyncThunk("userDetails/rest_auth_user_retrieve", async payload => {
...
const userDetailsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(rest_auth_user_retrieve.pending, (state, action) => {
