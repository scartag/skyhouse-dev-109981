...
export const rest_auth_login_create = createAsyncThunk("logins/rest_auth_login_create", async payload => {
...
const loginsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder.addCase(rest_auth_login_create.pending, (state, action) => {
